        ...
        if(isset($_REQUEST['submit']))
{
	...
	$hasError=0;
    $target_dir = "../upload/";
	$target_file = $target_dir . basename($_FILES["upic"]["name"]);
    ...
    else
    {
        ...
        {
            $phnErr = "<html><font color='red'>*Invalid Phone Number!</font></html>";
            $hasError=1;
        } 
        // else 
        // {
        ...
        //     foreach ((array)$phpObj as $value) 
        //     {
        //         if($value->phone==$_REQUEST['uphn'])
        //         {
        //             $phnErr = "<html><font color='red'>*Number already exist </font></html>";
        //             $hasError=1;
    ...
    if($hasError==0)
    {
        $cusdb = new CusDB();
        $conobj= $cusdb->openCon();
        $result=$cusdb->insertData("cusreg",$_REQUEST["uname"],$_REQUEST["uemail"],
