<?php 
   include '../Control/RegProcess.php'; 
   ?>
<!DOCTYPE html>
<html>
   <head>
         ...
         <h4>SIGN UP</h4>
            <div class=main-user-info>
               ...
               <div class=user-input-box>
                  ...
                  <input type="text" id="uphn" name="uphn" value="">
                  <p id="uphnError"></p>
                  <?php echo $phnErr;?>
               </div>
               ...
               <div class=user-input-box>
                  <label><b>NID:</b></label>
                  <input type="text" id="unid" name="unid" value="">
                  <p id="unidError"></p>
                  <?php echo $nidErr;?>
               </div>
                  ...
                  <input list="countries" id="country" name="ucountry" value=""> 
               ...
               <div class=user-input-box>
                  ...
                  <input type="file" id="upic" name="upic" value="">
                  <p id="upicError"></p>
                  <?php echo $picErr;?>
               </div>
               ...
               <div class=user-input-box>
                  ...
                  <textarea id="reg-textarea" name="uadd"></textarea>
                  <p id="uaddError"></p>
                  <?php echo $addErr;?>
               </div>
               ...
               <div class=user-input-box>
                  ...
                  <input type="password" id="ucpass" name="urepass" value="">
                  <p id="ucpassError"></p>
                  <?php echo $cpassErr;?>
               </div>
            </div>
            ...
            <div class=label-bottom>
               ...
               <span class=>Already have an account?<a href="CustomerLog.php"><?php echo " "?>Sign in</a></span>
            </div>
            </form>
         </div>   
